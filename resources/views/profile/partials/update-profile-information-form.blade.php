<div class="bg-white dark:bg-zinc-900/60 border border-zinc-300 dark:border-zinc-700 rounded-2xl p-5">
    ...
    <form method="post" action="{{ route('settings.avatar') }}" enctype="multipart/form-data" class="mb-5 pb-5 border-b border-zinc-200 dark:border-zinc-700/60">
        ...
        <div class="flex items-center gap-4">
            <div class="w-14 h-14 rounded-full overflow-hidden bg-orange-500 flex items-center justify-center text-xl font-bold text-white shrink-0">
                @if($user->avatarUrl())
            ...
            <div class="flex-1 min-w-0">
                ...
                <label for="avatar"
                    class="inline-flex items-center gap-2 px-3 py-1.5 bg-zinc-100 dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 rounded-lg text-xs text-zinc-600 dark:text-zinc-300 cursor-pointer hover:border-orange-500 hover:text-orange-500 transition-colors">
        ...
        <div>
            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div class="mt-2 flex items-center gap-3">
                    ...
                    <button form="send-verification" class="text-xs text-orange-500 hover:underline">
