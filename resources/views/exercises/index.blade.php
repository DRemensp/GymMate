    ...
    <div class="min-h-screen px-6 pt-8 pb-10">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mb-8 sm:pl-14 flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-white">{{ $trainingPlan->name }}</h1>
                        ...
                        <template x-teleport="body">
                            <div x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
                                ...
                                <div class="relative bg-zinc-900 rounded-2xl shadow-2xl w-full max-w-sm p-6 border border-zinc-800">
                                    <h3 class="text-white font-semibold mb-1">Übung löschen</h3>
                                    <p class="text-zinc-400 text-sm mb-4">
                                        Tippe <span class="text-red-400 font-mono">löschen</span> um <span class="text-white">„{{ $exercise->name }}"</span> und alle zugehörigen Einheiten zu entfernen.
                                    </p>
